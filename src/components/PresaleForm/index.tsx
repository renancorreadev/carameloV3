    ...
    <div className="presale-container flex-1 pb-10">
      <div className="presale-wrapper">
        <div className="presale-form">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="presale-info-row">
                  <div className="presale-info-label" style={{marginRight: '10px'}}>Tokens: </div>
                  <div className="presale-info-value large-number">{remaining}</div>
                </div>
              </div>

              {isConnected && allowedAddresses.includes(address?.toLowerCase() || '') && (
                <div className="presale-info-row">
                  ...
                  <span className="presale-info-value">{Number(totalRaised).toFixed(1)} BNB</span>
                </div>
              )}
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="bnb" className="presale-label w-full  items-center gap-2" style={{display: 'flex'}}>
                <img src="/bnb.png" alt="BNB" className="w-6 h-6" />
            ...
            {!isMobile && (
              <div id="connect-wallet" onClick={() => trackEvent("Connect Wallet")} className="mb-4">
            ...
            {isMobile && (
              <div className="presale-info-row">
                ...
                <span className="presale-info-value">{Number(BNBBalance).toFixed(8)} BNB</span>
              </div>
            )}
            ...
            {isMobile && (
              <TutorialModal isOpen={isModalOpen} onClose={() => setModalOpen(false)} />
            )}
          </div>
        </div>
      </div>
